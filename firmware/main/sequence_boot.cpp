...
namespace SequenceBoot{
    ...
    void step_1(void* ctx){
        ...
        LightingManager::leds[current_led_index_step_1].transition(0, 1, 0, 0.1);
    ...
    void step_2(void* ctx){
        ...
        LightingManager::leds[current_led_index_step_2].transition(0, 0, 1, 0.1);
    ...
    void step_3(void* ctx){
        ...
        LightingManager::leds[current_led_index_step_3].transition(1, 0, 0, 0.1);
    ...
    void step_4(void* ctx){
        ...
        LightingManager::leds[current_led_index_step_4].transition(0, 0, 0, 0.1);
    ...
    void init(){
        ...
        SequenceManager::sequence_steps[0].cooldown = 0.005;


        SequenceManager::sequence_steps[1].func = step_2;
        SequenceManager::sequence_steps[1].cooldown = 0.005;


        SequenceManager::sequence_steps[2].func = step_3;
        SequenceManager::sequence_steps[2].cooldown = 0.005;


        SequenceManager::sequence_steps[3].func = step_4;
        SequenceManager::sequence_steps[3].cooldown = 0.005;
    }
}